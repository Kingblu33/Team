...
const InfoSection = () => {
    return (
        <div className="flex flex-col items-center w-full max-w-4xl border border-gray-9 rounded">
            <img 
            ...
            <div className="flex items-start -mt-16 w-[94%] mx-auto">
                <img 
                    ...
                    alt="User Profile" 
                    className="lg:w-28 lg:h-26 outline outline-1 outline-gray-20 bg-white mb-3" 
                />
                <div className="flex flex-col ml-4 w-full">
                    <div className="flex justify-between items-center w-full">
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <button className="bg-blue-600 text-white px-3 py-2 rounded flex justify-between items-center hover:bg-blue-700">Follow 
